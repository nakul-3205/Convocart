// uncomment this script to run and get products in your db
...
// // Each image is tagged with the sub-category it actually depicts, and a
// // human-readable label parsed from its filename. This lets us pick an
// // image that matches a product's type instead of a fully random one.
// interface ImageMeta {
//   url: string;
...
// const IMAGE_SOURCE: [string, SubCategory, string][] = [
//   [
//     'https://res.cloudinary.com/dins3utus/image/upload/v1787723904/Lightweight_Running_Shoe_-_Blue_Grey_202608261124_aorqck.jpg',
//     'running',
//     'Lightweight Running Shoe - Blue Grey',
//   ],
//   [
//     'https://res.cloudinary.com/dins3utus/image/upload/v1787723905/Performance_Running_Shoe_-_Orange_202608261122_ectcbk.jpg',
//     'running',
//     'Performance Running Shoe - Orange',
//   ],
//   [
//     'https://res.cloudinary.com/dins3utus/image/upload/v1787723902/Cushioned_Long-Distance_Runner_202608261126_dz1nnp.jpg',
//     'running',
//     'Cushioned Long-Distance Runner',
//   ],
//   [
//     'https://res.cloudinary.com/dins3utus/image/upload/v1787723902/Minimalist_Everyday_Running_Shoe_202608261127_itplbn.jpg',
//     'running',
//     'Minimalist Everyday Running Shoe',
//   ],
//   [
//     'https://res.cloudinary.com/dins3utus/image/upload/v1787723904/Velocity_Mesh_202608261124_wmcly0.jpg',
//     'running',
//     'Velocity Mesh',
//   ],
//   [
//     'https://res.cloudinary.com/dins3utus/image/upload/v1787723903/EnduroFit_Trainer_202608261126_pnvpt5.jpg',
//     'running',
//     'EnduroFit Trainer',
//   ],
//   [
//     'https://res.cloudinary.com/dins3utus/image/upload/v1787723903/TrackStar_Lite_202608261127_wwyqyo.jpg',
//     'running',
//     'TrackStar Lite',
//   ],
//   [
//     'https://res.cloudinary.com/dins3utus/image/upload/v1787723904/Nimbus_Stride_202608261124_jb0y5h.jpg',
//     'running',
//     'Nimbus Stride',
//   ],
//   [
//     'https://res.cloudinary.com/dins3utus/image/upload/v1787723903/Classic_Low-Top_Canvas_Sneaker_202608261124_cyb0sx.jpg',
//     'casual',
//     'Classic Low-Top Canvas Sneaker',
//   ],
//   [
//     'https://res.cloudinary.com/dins3utus/image/upload/v1787723902/Modern_Sock-Fit_Knit_Sneaker_202608261127_ngsqnu.jpg',
//     'casual',
//     'Modern Sock-Fit Knit Sneaker',
//   ],
//   [
//     'https://res.cloudinary.com/dins3utus/image/upload/v1787723903/Casual_Suede_Sneaker_202608261125_jlci6e.jpg',
//     'casual',
//     'Casual Suede Sneaker',
//   ],
//   [
//     'https://res.cloudinary.com/dins3utus/image/upload/v1787723904/Retro_Court_Classic_202608261124_i2pci7.jpg',
//     'casual',
//     'Retro Court Classic',
//   ],
//   [
//     'https://res.cloudinary.com/dins3utus/image/upload/v1787723902/Canvas_High-Top_202608261125_gnmclz.jpg',
//     'casual',
//     'Canvas High-Top',
//   ],
//   [
//     'https://res.cloudinary.com/dins3utus/image/upload/v1787723903/Slip-On_Loafer_Sneaker_202608261126_gkg5z2.jpg',
//     'casual',
//     'Slip-On Loafer Sneaker',
//   ],
//   [
//     'https://res.cloudinary.com/dins3utus/image/upload/v1787723903/Denim_Low-Top_202608261127_oiuc4c.jpg',
//     'casual',
//     'Denim Low-Top',
//   ],
//   [
//     'https://res.cloudinary.com/dins3utus/image/upload/v1787723905/Boardwalk_Slip-On_202608261122_knxwq2.jpg',
//     'casual',
//     'Boardwalk Slip-On',
//   ],
//   [
//     'https://res.cloudinary.com/dins3utus/image/upload/v1787723904/Polished_Black_Leather_Oxford_202608261122_lhrlpg.jpg',
//     'formal',
//     'Polished Black Leather Oxford',
//   ],
//   [
//     'https://res.cloudinary.com/dins3utus/image/upload/v1787723904/Brown_Leather_Derby_Shoe_202608261124_noicrt.jpg',
//     'formal',
//     'Brown Leather Derby Shoe',
//   ],
//   [
//     'https://res.cloudinary.com/dins3utus/image/upload/v1787723903/Monk_Strap_Elite_202608261126_ehs4gh.jpg',
//     'formal',
//     'Monk Strap Elite',
//   ],
//   [
//     'https://res.cloudinary.com/dins3utus/image/upload/v1787723902/Brogue_Wingtip_202608261126_a1loiy.jpg',
//     'formal',
//     'Brogue Wingtip',
//   ],
//   [
//     'https://res.cloudinary.com/dins3utus/image/upload/v1787723903/Dark_Brown_Chelsea_Boot_202608261126_hmjwr4.jpg',
//     'formal',
//     'Dark Brown Chelsea Boot',
//   ],
//   [
//     'https://res.cloudinary.com/dins3utus/image/upload/v1787723902/Cap-Toe_Classic_202608261127_j7noic.jpg',
//     'formal',
//     'Cap-Toe Classic',
//   ],
//   [
//     'https://res.cloudinary.com/dins3utus/image/upload/v1787723904/Wingtip_Brogue_Deluxe_202608261124_zyg9vw.jpg',
//     'formal',
//     'Wingtip Brogue Deluxe',
//   ],
//   [
//     'https://res.cloudinary.com/dins3utus/image/upload/v1787723904/Penny_Loafer_Classic_202608261124_igxkqk.jpg',
//     'formal',
//     'Penny Loafer Classic',
//   ],
//   [
//     'https://res.cloudinary.com/dins3utus/image/upload/v1787723905/Chukka_Boot_Formal_202608261122_awofdc.jpg',
//     'formal',
//     'Chukka Boot Formal',
//   ],
//   [
//     'https://res.cloudinary.com/dins3utus/image/upload/v1787723905/Athletic_Running_Socks_202608261122_t0hybw.jpg',
//     'running',
//     'Athletic Running Socks',
//   ],
//   [
//     'https://res.cloudinary.com/dins3utus/image/upload/v1787723902/Sneaker_Cleaning_Kit_202608261126_euiuxg.jpg',
//     'casual',
//     'Sneaker Cleaning Kit',
//   ],
//   [
//     'https://res.cloudinary.com/dins3utus/image/upload/v1787723902/Shoe_Polish_Kit_202608261127_febe7i.jpg',
//     'formal',
//     'Shoe Polish Kit',
//   ],
// ];

// const IMAGE_META: ImageMeta[] = IMAGE_SOURCE.map(([rawUrl, subCategory, label]) => ({
//   url: cloudinarySquare(rawUrl),
//   subCategory,
//   label,
// }));
...
// function pickImageFor(name: string, subCategory: SubCategory): string {
//   const pool = IMAGE_META.filter((img) => img.subCategory === subCategory);
//   if (pool.length === 0) {
//     throw new Error(`No images available for sub-category "${subCategory}"`);
//   }
//   const target = normalize(name);
//   const exactMatch = pool.find((img) => normalize(img.label) === target);
...
//   ['Stratos Flyer', 'running', 3799, 10],
//   ['Pulse Runner', 'running', 3399, 12],
//   ['GripTech Trail', 'running', 4099, 9],
//   ['Ember Sprint', 'running', 3299, 11],
//   ['Glide Pro', 'running', 4599, 7],
...
//   ['Harbor Low', 'casual', 2199, 12],
//   ['Metro Slip', 'casual', 2599, 10],
//   ['Cloud Canvas', 'casual', 1999, 13],
//   ['Rally Sneaker', 'casual', 2799, 9],
//   ['Drift Low-Top', 'casual', 2099, 11],
...
//   ['Regal Oxford', 'formal', 5299, 5],
//   ['Heritage Derby', 'formal', 4999, 6],
//   ['Ambassador Loafer', 'formal', 4699, 7],
//   ['Executive Brogue', 'formal', 5099, 6],
//   ['Classic Monk', 'formal', 5399, 5],
// ];

// const shoeDescriptionTemplates: Record<SubCategory, (name: string) => string> = {
//   running: (name) =>
//     `${name} — lightweight running shoe with breathable mesh upper and cushioned sole, built for training and daily runs.`,
//   casual: (name) => `${name} — comfortable everyday sneaker designed for casual wear.`,
//   formal: (name) =>
//     `${name} — leather formal shoe with a polished finish, built for office and occasions.`,
// };

// const accessories: [string, SubCategory, number, number, string][] = [
//   [
//     'Moisture-Wicking Running Socks (Pair)',
//     'running',
//     399,
//     50,
//     'Breathable, cushioned socks designed for long runs.',
//   ],
//   [
//     'Performance Insoles',
//     'running',
//     599,
//     40,
//     'Extra cushioning insoles that fit under any running shoe.',
//   ],
//   [
...
//     449,
//     35,
//     'Supportive sleeves that reduce fatigue on long runs.',
//   ],
//   [
...
//     199,
//     60,
//     'Clip-on reflectors for visibility during evening runs.',
//   ],
//   ['Elastic No-Tie Laces', 'running', 299, 45, 'Stretch laces for a snug, tie-free fit.'],
//   [
//     'Anti-Blister Heel Pads',
//     'running',
//     249,
//     55,
//     'Cushioned pads that prevent heel rubbing on long runs.',
//   ],
//   [
//     'Running Shoe Deodorizer',
//     'running',
//     349,
//     30,
//     'Odor-neutralizing spray for post-run shoe care.',
//   ],
...
//     549,
//     32,
//     'Insoles with extra arch support for high-mileage runners.',
//   ],
//   [
//     'Quick-Dry Sport Socks (3-Pack)',
//     'running',
//     699,
//     38,
//     'Set of three moisture-wicking socks for training.',
//   ],
...
//     399,
//     28,
//     'Ventilated bag for carrying shoes to the gym or a race.',
//   ],
//   [
...
//     199,
//     40,
//     'Athletic tape that prevents blisters on long runs.',
//   ],
//   [
...
//     799,
//     20,
//     'Adjustable belt for carrying water on long runs.',
//   ],
//   [
...
//     899,
//     15,
//     'High-visibility vest for early morning or night runs.',
//   ],
//   [
//     'Carbon Fiber Insole',
//     'running',
//     549,
//     30,
//     'Rigid insole that adds energy return to running strides.',
//   ],
//   ['Anti-Chafe Balm', 'running', 299, 40, 'Skin-protecting balm for long-distance comfort.'],
//   ['Reflective Ankle Bands', 'running', 249, 45, 'Adjustable reflective bands for visibility.'],
//   ['Sport Water Bottle Clip', 'running', 349, 25, 'Clip-on holder for a water bottle during runs.'],
//   [
//     'Lightweight Running Cap',
//     'running',
//     399,
//     30,
//     'Breathable cap that shields against sun and sweat.',
//   ],
//   [
//     'Everyday Ankle Socks (Pair)',
//     'casual',
//     249,
//     60,
//     'Soft cotton-blend ankle socks for daily wear.',
//   ],
//   [
//     'Sneaker Cleaning Kit',
//     'casual',
//     899,
//     25,
//     'Brush and solution kit to keep sneakers looking new.',
//   ],
//   [
...
//     549,
//     22,
//     'Water- and stain-repellent spray for suede sneakers.',
//   ],
...
//   [
//     'Sneaker Insert Cushions',
//     'casual',
//     299,
//     35,
//     'Soft cushion inserts for all-day sneaker comfort.',
//   ],
//   ['Canvas Sneaker Wash Kit', 'casual', 649, 20, 'Gentle wash kit designed for canvas sneakers.'],
//   [
//     'Fabric Sneaker Protector Spray',
//     'casual',
//     499,
//     25,
//     'Stain-repellent spray for fabric sneakers.',
//   ],
//   ['Suede Brush Kit', 'casual', 449, 25, 'Brush set designed for cleaning suede sneakers.'],
//   ['Canvas Shoe Whitener', 'casual', 349, 30, 'Whitening solution for canvas sneakers.'],
//   ['No-Tie Elastic Laces (Casual)', 'casual', 229, 35, 'Stretch laces for slip-on convenience.'],
//   ['Shoe Deodorizing Pouches', 'casual', 279, 30, 'Odor-absorbing pouches for everyday sneakers.'],
//   ['Fabric Shoe Glue', 'casual', 399, 20, 'Repair adhesive for fabric and canvas sneakers.'],
...
//     899,
//     20,
//     'Cedar inserts that preserve shoe shape and absorb moisture.',
//   ],
...
//     799,
//     15,
//     'Adjustable stretcher for a more comfortable leather-shoe fit.',
//   ],
//   [
...
//     599,
//     20,
//     'Protective spray that guards leather against moisture.',
//   ],
//   [
...
//     249,
//     28,
//     'Grip pads that prevent heel slipping in leather shoes.',
//   ],
//   ['Formal Shoe Insoles', 'formal', 449, 26, 'Slim cushioned insoles designed for dress shoes.'],
//   [
//     'Leather Shoe Polish (Black)',
//     'formal',
//     399,
//     30,
//     'Classic black polish for leather dress shoes.',
//   ],
//   [
//     'Leather Shoe Polish (Brown)',
//     'formal',
//     399,
//     28,
//     'Classic brown polish for leather dress shoes.',
//   ],
...
//   ['Leather Care Wipes', 'formal', 349, 30, 'Quick-clean wipes for leather formal shoes.'],
//   ['Buckle Polish Kit', 'formal', 299, 25, 'Polish kit for metal buckles on monk-strap shoes.'],
//   [
//     'Leather Sole Protector Spray',
//     'formal',
//     449,
//     20,
//     'Protective spray extending the life of leather soles.',
//   ],
//   [
//     'Extra-Large Cedar Shoe Tree',
//     'formal',
//     749,
//     15,
//     'Large cedar tree for boots and bigger formal sizes.',
//   ],
//   [
//     'Monk Strap Cleaning Cloth',
//     'formal',
//     199,
//     35,
//     'Soft microfiber cloth for daily leather upkeep.',
//   ],
// ];
...
//     const imageUrl = pickImageFor(name, subCategory); // same, type-matched image across all sizes of this design
...
//         stock,
//         size: null,
//         imageUrl: pickImageFor(name, subCategory),
//       },
//     });
...
//     const crossSellData: { productId: string; crossSellProductId: string }[] = [];
//     for (const shoeId of shoeIdsBySub[sub]) {
//       for (const accId of accIdsBySub[sub]) {
//         crossSellData.push({ productId: shoeId, crossSellProductId: accId });
//       }
//     }
//     await prisma.productCrossSell.createMany({ data: crossSellData });
//   }

//   const totalShoes = shoeDesigns.length * SIZES.length;
//   console.log(
//     `Seeded ${totalShoes} shoe products + ${accessories.length} accessories = ${totalShoes + accessories.length} total.`,
//   );
// }
